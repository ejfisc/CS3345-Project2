...
public class P2Driver {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String operation = "";
            //int lineno = 0; Going to leave this here, but it's never used and VS Code didn't like that so I just commented it out.
            ...
            whileloop:
            while (in.hasNext()) {
                //lineno++; see comment at initialization
		...
		try {
                ...
                try {
                 ...
                 try {
                    ...
                    case "MakeEmpty":
                        //call the makeempty method of the linkedlist and empty the list
                        LL.makeEmpty();
                        break;
